SET NAMES UTF8;
DROP DATABASE IF EXISTS DiningRoom;
CREATE DATABASE DiningRoom CHARSET=UTF8;
USE DiningRoom;
...
INSERT INTO dr_settings VALUES
...
CREATE TABLE dr_reservation(
  ...
  dinnerTime BIGINT,
  tableId INT,
  FOREIGN KEY(tableId) REFERENCES dr_table(tid)
);
INSERT INTO dr_reservation VALUES
...
INSERT INTO dr_category VALUES
(1, '肉类'),
(2, '海鲜河鲜'),
(3, '丸滑类'),
(4, '蔬菜豆制品'),
...
CREATE TABLE dr_dish(
  ...
  detail VARCHAR(128),
  categoryId INT,
  FOREIGN KEY(categoryId) REFERENCES dr_category(cid)
);
INSERT INTO dr_dish VALUES
...
CREATE TABLE dr_order_detail(
  ...
  orderId INT,      /*订单编号*/
  FOREIGN KEY(dishId) REFERENCES dr_dish(did),
  FOREIGN KEY(orderId) REFERENCES dr_order(oid)
);
INSERT INTO dr_order_detail VALUES
(NULL, '50', '2', '丁丁', '100000'),
(NULL, '24', '2', '丁丁', '100001'),
(NULL, '37', '1', '当当', '100002'),
(NULL, '18', '3', '豆豆', '100003'),
